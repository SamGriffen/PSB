...
class NRF24
{
    ...
    public:     // Methods
        ...
        void send_message(uint8_t* msg); // Send message pointed to by msg

        void receive_message(uint8_t* msg); // Receive message. Store received message in memory pointed to by msg
